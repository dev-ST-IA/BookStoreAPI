        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatePoints = table.Column<double>(type: "float", nullable: false),
                    NoOfRaters = table.Column<int>(type: "int", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Publisher = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartProducts_Books_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_EmailAddress_Role",
                table: "Users",
                columns: new[] { "EmailAddress", "Role" },
                unique: true);
